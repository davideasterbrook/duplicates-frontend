...
export const inspirationCollections: InspirationCollection[] = [
  ...
  },
  {
    ...
    nfts: [
    {
      ...
      rarity: "Rare",
      staticMetadata: {
        description: "A community-driven collectibles project featuring art by Burnt Toast. Doodles come in a joyful range of colors, traits and sizes with a collection size of 10,000. Each Doodle allows its owner to vote ",
        attributes: [
  ...
  },
  {
    ...
    nfts: [
    {
      ...
      rarity: "Rare",
      staticMetadata: {
        description: "WOW!!!! You just found one of the 9 hidden cats. These are insanely rare. Clon and Xtremetom created them without telling the rest of the team. Please drop by our discord to let us know you found it. ",
        attributes: [
  ...
  },
  {
    ...
    nfts: [
    {
      ...
      rarity: "Rare",
      staticMetadata: {
        description: "🧬 CLONE X 🧬 20,000 next-gen Avatars, by RTFKT and Takashi Murakami 🌸 If you own a clone without any Murakami trait please read the terms regarding RTFKT - Owned Content here: https://rtfkt.com/lega",
        attributes: [
    ...
    },
    {
      ...
      rarity: "Rare",
      staticMetadata: {
        description: "🧬 CLONE X 🧬 20,000 next-gen Avatars, by RTFKT and Takashi Murakami 🌸 If you own a clone with even one Murakami trait please read the terms regarding third-party content here: https://rtfkt.com/lega",
        attributes: [
